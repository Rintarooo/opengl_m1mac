...
void display() {
	...
	float light_pos[4] ={5.0 * cos(angle), 5.0 * sin(angle), 5.0, 1.0f};
    // 光源の位置の定義
    ...
    */
    float camera_position[] = {5.0 * cos(angle), 5.0 * sin(angle), 5.0};
    // float look_at[] = {-1.0f, -1.0f, -1};
    float look_at[] = {0.0f, 0.0f, -1};
